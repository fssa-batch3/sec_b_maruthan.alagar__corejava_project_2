...
/**
 * The ShopValidator class provides methods for validating shop-related operations.
 */
public class ShopValidator {
     ...
     * @param inputName   The name of the input (e.g., "Phone Number") for error messages.
